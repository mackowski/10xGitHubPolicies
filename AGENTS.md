...
- **Secret Management**: Never hard-code secrets (passwords, API keys, connection strings). Use the .NET Secret Manager for local development and GitHub Secrets for production deployments via CI/CD pipelines.
...
- Refer to `/docs/services/github-integration.md` for detailed usage examples and best practices.
...
- Refer to `/docs/services/policy-evaluation.md` for a detailed guide on creating new evaluators.
...
- Refer to `/docs/services/configuration-service.md` for detailed usage examples and configuration format.
